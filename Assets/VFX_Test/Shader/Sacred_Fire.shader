...
Shader "Sacred_Fire"
{
	...
	SubShader
	{
		...
		void vertexDataFunc( inout appdata_full v, out Input o )
		{
			...
			float4 Nois106 = pow( ( tex2Dlod( _T_Lu_Noise_01, float4( uv_TexCoord98, 0, 0.0) ) + tex2Dlod( _TextureSample0, float4( uv_TexCoord97, 0, 0.0) ) ) , 4.0 );
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float4 Nois106 = pow( ( tex2D( _T_Lu_Noise_01, uv_TexCoord98 ) + tex2D( _TextureSample0, uv_TexCoord97 ) ) , 4.0 );
...
/*ASEBEGIN
Version=16100
85;545;1077;469;4811.003;1532.845;6.52789;True;False
...
ASEEND*/
//CHKSM=C2F00CF9C647D5AC80DC658E2636BBE2363BC46E
...
Shader "Sacred_Fire"
{
	Properties
	{
		...
		_Speed_Noise_Secondary("Speed_Noise_Secondary", Vector) = (2,0,0,0)
		_Emission("Emission", Float) = 3
		_T_Lu_Noise_08("T_Lu_Noise_08", 2D) = "white" {}
	...
	SubShader
	{
		...
		uniform sampler2D _T_Lu_Noise_08;
		...
		void vertexDataFunc( inout appdata_full v, out Input o )
		{
			...
			float4 temp_output_126_0 = ( tex2Dlod( _TextureSample2, float4( uv_TexCoord98, 0, 0.0) ) + tex2Dlod( _T_Lu_Noise_08, float4( uv_TexCoord97, 0, 0.0) ) );
			float4 Nois106 = pow( temp_output_126_0 , 8.0 );
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float4 temp_output_126_0 = ( tex2D( _TextureSample2, uv_TexCoord98 ) + tex2D( _T_Lu_Noise_08, uv_TexCoord97 ) );
			float4 Nois106 = pow( temp_output_126_0 , 8.0 );
...
/*ASEBEGIN
Version=16100
369;529;1077;469;2472.993;1856.422;2.18984;True;False
Node;AmplifyShaderEditor.Vector2Node;92;-2524.746,-1951.629;Float;False;Property;_Speed_Noise_1;Speed_Noise_1;2;0;Create;True;0;0;False;0;3,1;0,-1;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.Vector2Node;91;-2585.736,-1479.97;Float;False;Property;_Speed_Noise_Secondary;Speed_Noise_Secondary;6;0;Create;True;0;0;False;0;2,0;1,-1;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.Vector2Node;95;-2308.304,-1749.654;Float;False;Property;_Tiling_Noise_Secondary;Tiling_Noise_Secondary;0;0;Create;True;0;0;False;0;0,0;1,1;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.SamplerNode;139;-1895.075,-1416.128;Float;True;Property;_T_Lu_Noise_08;T_Lu_Noise_08;14;0;Create;True;0;0;False;0;8167dd3e273ef0d44a326834715fa0db;8167dd3e273ef0d44a326834715fa0db;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;140;-889.3757,-1998.508;Float;True;Property;_TextureSample2;Texture Sample 2;15;0;Create;True;0;0;False;0;8167dd3e273ef0d44a326834715fa0db;8167dd3e273ef0d44a326834715fa0db;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.CommentaryNode;102;-2577.645,-1210.403;Float;False;1966.161;816.4471;Noise;2;106;124;Noise;1,1,1,1;0;0
Node;AmplifyShaderEditor.PowerNode;124;-1112.451,-1143.982;Float;False;2;0;COLOR;0,0,0,0;False;1;FLOAT;8;False;1;COLOR;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;106;-867.8674,-996.9074;Float;False;Nois;-1;True;1;0;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.RangedFloatNode;108;-319.4435,-550.5659;Float;False;Property;_Emission;Emission;7;0;Create;True;0;0;False;0;3;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;38;284.5471,-943.3813;Float;False;Property;_GlowColor;Glow Color;4;1;[HDR];Create;True;0;0;False;0;0.6564829,0,1.717647,0;2.092463,0.5477651,0.6256691,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;135;-1390.635,-1670.385;Float;True;Property;_TextureSample1;Texture Sample 1;13;0;Create;True;0;0;False;0;b51a20d4daf88cb47a4761d87a406244;b51a20d4daf88cb47a4761d87a406244;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;131;-1239.739,-2151.874;Float;True;Property;_T_Lu_Noise_33;T_Lu_Noise_33;11;0;Create;True;0;0;False;0;793d5e26fad6ef740bffe773249356e3;793d5e26fad6ef740bffe773249356e3;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;132;-1702.626,-1583.33;Float;True;Property;_TextureSample0;Texture Sample 0;10;0;Create;True;0;0;False;0;6ca5b2e608f86e14d88db87d75ba2f41;6ca5b2e608f86e14d88db87d75ba2f41;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.NoiseGeneratorNode;100;-1751.517,-1826.575;Float;False;Simplex2D;1;0;FLOAT2;0,0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FractNode;125;-631.8592,-1563.364;Float;False;1;0;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SamplerNode;133;-1355.49,-1918.235;Float;True;Property;_Noise_Alveole;Noise_Alveole;12;0;Create;True;0;0;False;0;b51a20d4daf88cb47a4761d87a406244;b51a20d4daf88cb47a4761d87a406244;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4

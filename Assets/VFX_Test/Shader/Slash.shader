		...
		SubShader
		{
			...
			Pass {
				...
				fixed4 frag ( v2f i  ) : SV_Target
				{
					...
					float4 smoothstepResult22 = smoothstep( temp_cast_0 , temp_cast_1 , ( tex2D( _TexturePrincipale, saturate( appendResult19 ) ) * pow( frac( ( tex2D( _T_Lu_Noise_01, uv103 ) + tex2D( _TextureSample0, uv104 ) ) ) , 1.0 ) ));
...
/*ASEBEGIN
Version=16100
425;546;1077;463;1366.587;328.6411;1;True;False
...
Node;AmplifyShaderEditor.SamplerNode;106;505.0765,1042.812;Float;True;Property;_TextureSample0;Texture Sample 0;7;0;Create;True;0;0;False;0;6ca5b2e608f86e14d88db87d75ba2f41;793d5e26fad6ef740bffe773249356e3;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;105;906.6824,280.3157;Float;True;Property;_T_Lu_Noise_01;T_Lu_Noise_01;6;0;Create;True;0;0;False;0;6ca5b2e608f86e14d88db87d75ba2f41;77b8da28db61ae746812cbc825081cde;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.PowerNode;109;1497.491,641.9958;Float;False;2;0;COLOR;0,0,0,0;False;1;FLOAT;1;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;110;912.9532,-3.574682;Float;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
ASEEND*/
//CHKSM=1C29ECFFEB408049752E2D3C56ECE6B433A3FBFE
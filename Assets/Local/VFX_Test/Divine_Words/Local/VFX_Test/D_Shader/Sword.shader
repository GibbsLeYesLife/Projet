...
Shader "Sword"
{
	...
	SubShader
	{
		...
		void vertexDataFunc( inout appdata_full v, out Input o )
		{
			...
			float4 Nois106 = pow( ( tex2Dlod( _T_Lu_Noise_01, float4( uv_TexCoord98, 0, 0.0) ) + tex2Dlod( _TextureSample0, float4( uv_TexCoord97, 0, 0.0) ) ) , 3.0 );
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float4 Nois106 = pow( ( tex2D( _T_Lu_Noise_01, uv_TexCoord98 ) + tex2D( _TextureSample0, uv_TexCoord97 ) ) , 3.0 );
			float4 Emission36 = ( ( Nois106 * _Emission ) * _GlowColor );
			float2 uv_TextureSample1 = i.uv_texcoord * _TextureSample1_ST.xy + _TextureSample1_ST.zw;
			o.Emission = ( Emission36 + ( 0.8 * tex2D( _TextureSample1, uv_TextureSample1 ) ) ).rgb;
			o.Alpha = 1;
		}
...
/*ASEBEGIN
Version=16100
425;546;1077;463;1230.335;-733.7402;1.550907;True;False
Node;AmplifyShaderEditor.Vector2Node;92;-2524.746,-1951.629;Float;False;Property;_Speed_Noise_1;Speed_Noise_1;2;0;Create;True;0;0;False;0;3,1;0.5,1.5;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.Vector2Node;91;-2585.736,-1479.97;Float;False;Property;_Speed_Noise_Secondary;Speed_Noise_Secondary;6;0;Create;True;0;0;False;0;0,0;0.1,1.5;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.Vector2Node;95;-2308.304,-1749.654;Float;False;Property;_Tiling_Noise_Secondary;Tiling_Noise_Secondary;0;0;Create;True;0;0;False;0;0,0;3,1;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.SamplerNode;132;-1739.836,-1625.855;Float;True;Property;_TextureSample0;Texture Sample 0;10;0;Create;True;0;0;False;0;6ca5b2e608f86e14d88db87d75ba2f41;f14110649c348ba4bac48297b5bdf83d;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.PowerNode;124;-494.7801,-1512.527;Float;False;2;0;COLOR;0,0,0,0;False;1;FLOAT;3;False;1;COLOR;0
...
Node;AmplifyShaderEditor.RangedFloatNode;108;-319.4435,-550.5659;Float;False;Property;_Emission;Emission;7;0;Create;True;0;0;False;0;3;3;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;38;284.5471,-943.3813;Float;False;Property;_GlowColor;Glow Color;4;1;[HDR];Create;True;0;0;False;0;0.6564829,0,1.717647,0;1.936521,0.202777,0,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;59;-638.6398,253.071;Float;False;Property;_OffsetValue;OffsetValue;5;0;Create;True;0;0;False;0;0.5;0.005;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;133;-538.0383,848.811;Float;True;Property;_TextureSample1;Texture Sample 1;11;0;Create;True;0;0;False;0;None;de7548559e0cd7441b3ab195602eaf05;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;136;-342.9437,1100.669;Float;False;Constant;_Float0;Float 0;12;0;Create;True;0;0;False;0;0.8;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;135;-178.4369,703.7283;Float;False;2;2;0;FLOAT;0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.GetLocalVarNode;28;-220.0872,430.9223;Float;False;36;Emission;1;0;OBJECT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;57;60.88782,762.5047;Float;False;56;VertexOffset;1;0;OBJECT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleAddOpNode;134;110.7563,453.2691;Float;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.FractNode;125;-893.8946,-1382.012;Float;False;1;0;COLOR;0,0,0,0;False;1;COLOR;0
...
ASEEND*/
//CHKSM=4F1A5F201F5918CE2742FEBF9BBE09B93C6688AC
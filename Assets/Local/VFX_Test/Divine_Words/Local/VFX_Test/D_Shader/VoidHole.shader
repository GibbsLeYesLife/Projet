...
Shader "VoidHole"
{
	...
	SubShader
	{
		...
		void vertexDataFunc( inout appdata_full v, out Input o )
		{
			...
			float4 Nois106 = pow( ( tex2Dlod( _T_Lu_Noise_01, float4( uv_TexCoord98, 0, 0.0) ) + tex2Dlod( _TextureSample0, float4( uv_TexCoord97, 0, 0.0) ) ) , 2.0 );
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float4 Nois106 = pow( ( tex2D( _T_Lu_Noise_01, uv_TexCoord98 ) + tex2D( _TextureSample0, uv_TexCoord97 ) ) , 2.0 );
...
/*ASEBEGIN
Version=16100
85;545;1077;469;2441.427;1758.223;2.113226;True;False
Node;AmplifyShaderEditor.Vector2Node;92;-2524.746,-1951.629;Float;False;Property;_Speed_Noise_1;Speed_Noise_1;2;0;Create;True;0;0;False;0;3,1;1,1;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.SamplerNode;118;-1338.23,-2388.351;Float;True;Property;_T_Lu_Noise_01;T_Lu_Noise_01;9;0;Create;True;0;0;False;0;6ca5b2e608f86e14d88db87d75ba2f41;d700dfdaae9f94a459c31181b819588f;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;132;-1702.626,-1583.33;Float;True;Property;_TextureSample0;Texture Sample 0;10;0;Create;True;0;0;False;0;6ca5b2e608f86e14d88db87d75ba2f41;921855d8ec2a77b489d5cd1ea56aff20;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.PowerNode;124;-1250.857,-1209.99;Float;False;2;0;COLOR;0,0,0,0;False;1;FLOAT;2;False;1;COLOR;0
...
Node;AmplifyShaderEditor.ColorNode;38;284.5471,-943.3813;Float;False;Property;_GlowColor;Glow Color;4;1;[HDR];Create;True;0;0;False;0;0.6564829,0,1.717647,0;1.733618,0.6420809,3.065936,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=BC09BF02687E584D3F7E0AEF3EBBED3EC44F7A31
...
Shader "Shield_Cover"
{
	...
	SubShader
	{
		...
		void vertexDataFunc( inout appdata_full v, out Input o )
		{
			...
			float4 Nois106 = pow( frac( ( tex2Dlod( _T_Lu_Noise_01, float4( uv_TexCoord98, 0, 0.0) ) + tex2Dlod( _TextureSample0, float4( uv_TexCoord97, 0, 0.0) ) ) ) , 5.0 );
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float4 Nois106 = pow( frac( ( tex2D( _T_Lu_Noise_01, uv_TexCoord98 ) + tex2D( _TextureSample0, uv_TexCoord97 ) ) ) , 5.0 );
...
/*ASEBEGIN
Version=16100
425;546;1077;463;4270.489;2685.518;4.875891;True;False
...
Node;AmplifyShaderEditor.Vector2Node;91;-2585.736,-1479.97;Float;False;Property;_Speed_Noise_Secondary;Speed_Noise_Secondary;6;0;Create;True;0;0;False;0;0,0;0.13,1.2;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
ASEEND*/
//CHKSM=D804547DBC58507CBC7D540FF20FFBABA9018843